...
public class Main {
    String url = "jdbc:mysql://localhost:3306/AmdocsBloodManagement";
    String user = "dewashish_verma";
    String password = "@Ashish114142";
    ...
    public static void donorDashBoard(Scanner scanner) {
        final String url = "jdbc:mysql://localhost:3306/AmdocsBloodManagement";
        final String user = "dewashish_verma";
        final String password = "@Ashish114142";
        int choice = 5;
        do {
            System.out.println(" ");
            ...
            System.out.println("4: List All Donor");
            ...
            switch (choice) {
                ...
                case 2: {
                    ...
                    try  {
                        ...
                        System.out.println("3. DonorAddress");
                ...
                case 3: {
                    ...
                    try{
                        ...
                        ResultSet resultSet = checkStatement.executeQuery();
                        System.out.println("id      DonorName    BloodGroup     ContactDetails  ");
    ...
    public static void receiverDashBoard(Scanner scanner) {
        ...
        do {
            ...
            System.out.println("4: List Reciver Details");
            System.out.println("5: Exit");
            System.out.println("===============================");
            System.out.print("Enter your Choice");
            choice = Integer.parseInt(scanner.nextLine());
            ...
            switch (choice) {
                case 1: {
                    ...
                    try {
                        ...
                        System.out.print("Enter Receiver Blood Group: ");
                        String requiredBloodGroup = scanner.nextLine();
                        System.out.print("Enter Receiver Contact Details: ");
                        String contactDetails = scanner.nextLine();
...
//                        System.out.println("4:");
                ...
                case 3: {
                    ...
                    try{
                        ...
                        PreparedStatement checkStatement = connection.prepareStatement(query);
                        ResultSet resultSet = checkStatement.executeQuery();
                        System.out.println("id      ReceiverName    BloodGroup     ContactDetails  Address");
                        while(resultSet.next()){
                            System.out.println(resultSet.getInt(1)+"        "+resultSet.getString(2)+"   "+
